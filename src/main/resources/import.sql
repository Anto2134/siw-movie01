...
insert into artist(nascita, id, cognome, nome) values('21/02/2001',nextval('hibernate_sequenceartist'), 'Rossi', 'Francesco');
insert into artist(nascita, id, cognome, nome) values('21/02/2002',nextval('hibernate_sequenceartist'), 'Bianchi', 'Nicolo');
insert into artist(nascita, id, cognome, nome) values('21/02/2009',nextval('hibernate_sequenceartist'), 'Verdi', 'Matteo');
insert into artist(nascita, id, cognome, nome) values('21/02/2008',nextval('hibernate_sequenceartist'), 'Neri', 'Antonio');
insert into artist(nascita, id, cognome, nome) values('21/02/2007',nextval('hibernate_sequenceartist'), 'Blu', 'Gennaro');
insert into artist(nascita, id, cognome, nome) values('21/02/2006',nextval('hibernate_sequenceartist'), 'Giallo', 'Roberto');
insert into artist(nascita, id, cognome, nome) values('21/02/2005',nextval('hibernate_sequenceartist'), 'Nero', 'Marco');
insert into artist(nascita, id, cognome, nome) values('21/02/2004',nextval('hibernate_sequenceartist'), 'Bianco', 'Alessandro');